...
export default async function CheckoutSuccessPage({
    ...
    if (!bookingId) redirect("/dashboard/user/bookings");
    ...
    if (!booking) redirect("/dashboard/user/bookings");

    const isTransfer = booking.paymentMethod === 'transfer';
    const isCash = booking.paymentMethod === 'cash';
    const isStripe = booking.paymentMethod === 'stripe'; // Assuming stripe means paid immediately for this logic
