            ...
            <section className="py-24">
                <div className="container mx-auto px-4">
                    <div className="mb-16 text-center lg:text-left">
                        <h2 className="text-3xl font-black text-gray-900 tracking-tight">Mapa Interactivo</h2>
                        <p className="text-gray-500 font-bold mt-2">Haz clic en los destinos para ver detalles y excursiones disponibles.</p>
                    </div>
            ...
            <section className="py-24 bg-gray-900 text-white rounded-[4rem] mx-4 mb-12 overflow-hidden shadow-2xl relative">
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-16">
                        <div>
                            <h2 className="text-4xl font-black tracking-tight mb-2">Todos los Destinos</h2>
                            <p className="text-gray-400 font-medium">Navega por las zonas más emblemáticas de la isla.</p>
                        </div>
                        ...
                        {destinationCards.map((dest, i) => (
                            ...
                            >
                                ...
                                <div className="absolute inset-0 bg-gradient-to-t from-gray-950 via-gray-950/20 to-transparent p-8 flex flex-col justify-end">
                                    <p className="text-xs font-black text-primary uppercase tracking-[0.2em] mb-2">{dest.tours} Excursiones</p>
