            ...
            <div className="container mx-auto px-4 py-12">
                            ...
                            >
                                ...
                                <div className="pt-10 pb-6 px-6">
                                    ...
                                    <div className="mt-6 pt-4 border-t border-gray-50 flex items-center justify-between opacity-60 group-hover:opacity-100 transition-opacity">
                                        <span className="text-xs text-gray-400 font-bold uppercase tracking-wider">{t('viewProfile')}</span>
                ...
                {sortedAgencies.length === 0 && (
                    <div className="text-center py-20">
                        ...
                        <h3 className="text-xl font-bold text-gray-900">{t('noAgencies')}</h3>
