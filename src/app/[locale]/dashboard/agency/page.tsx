    ...
    return (
        <div className="space-y-8">
            <div>
                ...
                <p className="text-gray-500">{t('subtitle', { name: agency.name })}</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                        <p className="text-sm text-gray-500 font-bold uppercase tracking-wide mb-1">{t('totalRevenue')}</p>
                ...
                <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex items-center gap-4">
                    ...
                    <div>
                        <p className="text-sm text-gray-500 font-bold uppercase tracking-wide">{t('confirmedBookings')}</p>
                ...
                <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex items-center gap-4">
                    ...
                    <div>
                        <p className="text-sm text-gray-500 font-bold uppercase tracking-wide">{t('activeTours')}</p>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
                    <div>
                        ...
                        <p className="text-xs text-gray-500">{t('manageListings')}</p>
                    </div>
                ...
                {agency.tours.length > 0 ? (
                    ...
                    <div className="text-center py-10 bg-gray-50 rounded-xl border-2 border-dashed border-gray-100 group hover:border-primary/30 transition-colors">
                        ...
                        <h3 className="text-sm font-bold text-gray-900">{t('emptyStateTitle')}</h3>
                        <p className="text-xs text-gray-500 mb-4 max-w-[200px] mx-auto">{t('emptyStateDesc')}</p>
            ...
            <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
                <h3 className="text-xl font-bold text-gray-900 mb-6">📈 {t('monthlyPerformance')}</h3>
                <div className="h-64 flex flex-col items-center justify-center bg-gray-50 rounded-2xl border-2 border-dashed border-gray-200 text-center p-6">
                    ...
                    <h4 className="font-bold text-gray-400">{t('detailedStats')}</h4>
                    <p className="text-sm text-gray-400 max-w-xs mt-1">{t('comingSoon')}</p>
                </div>
            </div>
        </div>
    );
